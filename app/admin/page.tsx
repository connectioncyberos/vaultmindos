    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-md border border-neutral-200 p-4">
          ...
          <p className="mt-1 text-2xl font-bold text-neutral-900">{counts.published}</p>
        </div>
        <div className="rounded-md border border-neutral-200 p-4">
          <p className="text-xs uppercase tracking-wide text-neutral-500">Rascunhos</p>
          <p className="mt-1 text-2xl font-bold text-neutral-900">{counts.draft}</p>
        </div>
        <div className="rounded-md border border-neutral-200 p-4">
          <p className="text-xs uppercase tracking-wide text-neutral-500">Arquivados</p>
          <p className="mt-1 text-2xl font-bold text-neutral-900">{counts.archived}</p>
        </div>
      </section>
