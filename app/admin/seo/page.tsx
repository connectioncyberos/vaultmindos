...
export default async function AdminSeoPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <h1 className="text-3xl font-bold leading-tight text-neutral-900">SEO</h1>
              ...
              return (
                <tr key={artigo.id} className="border-b border-neutral-100">
                  ...
                  <td className="py-2 pr-2 text-neutral-600">
                    {artigo.seo_title ?? <span className="text-red-600">faltando</span>}
                  </td>
                  <td className="py-2 pr-2 text-neutral-600">
                    {artigo.seo_description ?? <span className="text-red-600">faltando</span>}
                  </td>
