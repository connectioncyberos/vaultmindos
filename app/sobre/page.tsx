  ...
  return (
    <>
      ...
      <Container className="flex flex-col gap-6 py-6">
        <h1 className="text-3xl font-bold leading-tight text-neutral-100">Sobre</h1>
        ...
        <section className="mt-3 border-t border-neutral-800 pt-6">
          <h2 className="text-lg font-semibold text-neutral-100">Como o conteúdo é organizado</h2>
        ...
        <section className="mt-3">
          <h2 className="text-lg font-semibold text-neutral-100">Construído sobre a CDP</h2>
          <p className="mt-2 text-sm leading-relaxed text-neutral-400">
