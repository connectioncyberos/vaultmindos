  ...
  return (
    <>
      ...
      <Container className="flex flex-col gap-6 py-6">
        ...
        <h1 className="text-3xl font-bold leading-tight text-neutral-900">Comparativos</h1>
        ...
        <section className="mt-3 border-t border-neutral-200 pt-6">
          {artigos.length === 0 ? (
            <p className="text-sm text-neutral-600">Nenhum comparativo publicado ainda.</p>
          ) : (
